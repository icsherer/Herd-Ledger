...
export const IMPORT_HL_FIELDS = ["Name", "Tag", "Species", "Breed", "Sex", "Date of Birth", "Color", "Purchase Date", "Notes", "Acquisition Type", "Purchase Price", "Purchased From", "Current Pasture", "Dam Name", "Sire Name", "Registration Number", "Scrapie Tag", "Microchip ID", "Tattoo ID"];
